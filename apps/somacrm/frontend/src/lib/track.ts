/**
 * somacrm product analytics — posts to tennetctl /v1/track.
 *
...
const STORAGE_KEY = "somacrm_distinct_id";
const SESSION_KEY = "somacrm_session_id";
const IDENTITY_KEY = "somacrm_identity";
...
export function track(
  ...
  const body = {
    ...
    properties: { ...properties, app: "somacrm" },
