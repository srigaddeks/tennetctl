"""Health routes — /v1/somacrm/health (proxy round-trip check)."""
...
_service = import_module("apps.somacrm.backend.02_features.00_health.service")
_response = import_module("apps.somacrm.backend.01_core.response")

router = APIRouter(prefix="/v1/somacrm", tags=["health"])
