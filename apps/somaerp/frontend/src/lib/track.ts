/**
 * somaerp product analytics — posts to tennetctl /v1/track.
 *
...
const STORAGE_KEY = "somaerp_distinct_id";
const SESSION_KEY = "somaerp_session_id";
const IDENTITY_KEY = "somaerp_identity";
...
export function track(
  ...
  const body = {
    ...
    properties: { ...properties, app: "somaerp" },
