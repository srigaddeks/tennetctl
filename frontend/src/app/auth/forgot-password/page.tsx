  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-zinc-950">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-sm dark:bg-zinc-900">
        <h1 className="mb-1 text-lg font-semibold" data-testid="forgot-password-heading">
          Reset your password
        </h1>
        ...
        <p className="mt-6 text-sm text-zinc-600 dark:text-zinc-400">
          <Link href="/auth/signin" className="font-medium text-zinc-900 underline dark:text-zinc-100" data-testid="back-to-signin">
            Back to sign in
          </Link>
        </p>
      </div>
