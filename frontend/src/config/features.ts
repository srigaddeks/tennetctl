...
export const FEATURES: FeatureNav[] = [
  ...
  },
  {
    key: "product-ops",
    label: "Product Ops",
    description: "Mixpanel/PostHog-class anonymous-first product analytics. Browser SDK ingest, UTM attribution, live event tail, visitor drilldown.",
    basePath: "/product",
    testId: "nav-feature-product-ops",
    subFeatures: [
      { href: "/product", label: "Events", testId: "nav-product-events" },
      { href: "/product/utm", label: "UTM Campaigns", testId: "nav-product-utm" },
      { href: "/product/links", label: "Link Shortener", testId: "nav-product-links" },
      { href: "/product/referrals", label: "Referrals", testId: "nav-product-referrals" },
