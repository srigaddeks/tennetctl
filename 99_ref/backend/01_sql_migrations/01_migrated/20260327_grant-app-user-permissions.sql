...
-- Grants USAGE on all application schemas and full DML on all tables/sequences
-- to every kcontrol_*_write and kcontrol_*_read role found in the cluster.
-- Run by migration job (ADMIN_USER) so it has GRANT privilege.
