...
-- Ensure platform_admin category exists (not seeded in create-auth-feature-governance-v2)
INSERT INTO "03_auth_manage"."11_dim_feature_flag_categories" (id, code, name, description, sort_order, created_at, updated_at)
SELECT '00000000-0000-0000-0000-000000000150', 'platform_admin', 'Platform Admin', 'Feature flags for administrative platform operations.', 50, NOW(), NOW()
