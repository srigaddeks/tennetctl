...
- **Thin community `Community 588`** (1 nodes): `notify.templates.nodes.safelist — SQL safelist validator for dynamic_sql variabl`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 589`** (1 nodes): `Raises ValueError if sql_template fails safelist checks (save-time validation).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 590`** (1 nodes): `notify.templates.render — Jinja2 StrictUndefined template rendering node.  Contr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 591`** (1 nodes): `notify.send.transactional — Effect node for direct transactional delivery.  Crea`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 592`** (1 nodes): `Poll + send queued email deliveries. Returns number successfully sent.     Each`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 593`** (1 nodes): `Record an email open and return a 1px transparent GIF.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 594`** (1 nodes): `Record a bounce received from an SMTP provider.      Hard bounces (any bounce hi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 595`** (1 nodes): `Match event_key against a subscription pattern.      Rules:       - "*"`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 596`** (1 nodes): `All active subscriptions for the worker's matching loop.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 597`** (1 nodes): `iam.roles.create — effect node.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 598`** (1 nodes): `iam.roles.get — control node.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 599`** (1 nodes): `Count tokens created for this email in the last N minutes (rate-limit check).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 600`** (1 nodes): `Generate WebAuthn authentication options for a given email.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 601`** (1 nodes): `Sanitized key row — secret_hash never leaves the server.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 602`** (1 nodes): `iam.workspaces.get — control node (read-only cross-sub-feature lookup).  Returns`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 603`** (1 nodes): `iam.workspaces.create — effect node.  Validates parent org exists, creates a wor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 604`** (1 nodes): `Soft delete + audit. Raises NotFoundError if missing / already deleted.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 605`** (1 nodes): `Flat shape returned to API callers. Mirrors v_orgs (minus deleted_at).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 606`** (1 nodes): `Paginated list of orgs. Always excludes soft-deleted rows. Optional     is_activ`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 607`** (1 nodes): `Bump updated_at / updated_by without other column changes (e.g. after an attr up`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 608`** (1 nodes): `iam.orgs.get — control node (read-only cross-sub-feature lookup).  Returns the f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 609`** (1 nodes): `iam.orgs.create — effect node.  Creates an org (fct_orgs row + display_name attr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 610`** (1 nodes): `VaultClient — app-singleton in-process reader for vault secrets.  Every backend`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 611`** (1 nodes): `Raised when VaultClient.get is called with a key that does not exist.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 612`** (1 nodes): `Return the latest non-deleted plaintext for `key`. Raises VaultSecretNotFound.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 613`** (1 nodes): `Same as get() but also returns the version number.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 614`** (1 nodes): `Drop a key from the cache. Called by rotate/delete service paths.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 615`** (1 nodes): `Drop every cache entry. No wire path yet; used by tests + future LISTEN/NOTIFY.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 616`** (1 nodes): `Concept: WebAuthn passkey register/auth flow (challenge-response, sign_count replay protection)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 617`** (1 nodes): `Concept: Org membership (user-org lnk, immutable, hard-delete on revoke)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 618`** (1 nodes): `Concept: Workspace membership (user-workspace lnk, org_id auto-derived, immutable)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 619`** (1 nodes): `OAuth2 provider support: Google and GitHub code-exchange flows (OAuthCallbackBody: code + redirect_uri)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 620`** (1 nodes): `Groups as RBAC building block: org-scoped, code-unique per org, EAV attributes (code/label/description)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 621`** (1 nodes): `NATS JetStream streams for monitoring: workqueue retention for logs/spans, limits retention for DLQ`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 622`** (1 nodes): `DB table: 02_vault.11_fct_vault_configs (plaintext typed configs)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 623`** (1 nodes): `DB view: 02_vault.v_vault_configs (joins scope + value_type codes, pivots description)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 624`** (1 nodes): `DB table: 04_audit.60_evt_audit (append-only audit events)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 625`** (1 nodes): `DB view: 04_audit.v_audit_events (joins dim_audit_categories + dim_audit_event_keys)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 626`** (1 nodes): `Env-var contract: secrets belong in vault not env (ADR-028)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 627`** (1 nodes): `Migration file layout (03_docs/features/{nn}/05_sub_features/{nn}/09_sql_migrations/)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 628`** (1 nodes): `Manifest parser + Pydantic models — the NCP v1 §3 grammar.  Pydantic models ARE`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 629`** (1 nodes): `Base class for catalog errors. Every subclass carries a stable error code.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 630`** (1 nodes): `Per-node execution policy (NCP v1 §8).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 631`** (1 nodes): `What a sub-feature owns in terms of DB objects + seeds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 632`** (1 nodes): `Single node entry in a sub-feature's `nodes:` list.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 633`** (1 nodes): `Route entry — kept loose for v1 (not upserted into catalog this plan).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 634`** (1 nodes): `UI page entry — kept loose for v1.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 635`** (1 nodes): `Sub-feature entry under `spec.sub_features`.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 636`** (1 nodes): `Top-level feature manifest — whole YAML file.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 637`** (1 nodes): `Load + validate a single feature.manifest.yaml file.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 638`** (1 nodes): `Find every feature.manifest.yaml under:     - {root}/backend/02_features/*/featu`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 639`** (1 nodes): `Return (user_id, org_id) from the session — API keys can't mint keys.      `org_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 640`** (1 nodes): `Resolve an anonymous visitor to an IAM user. Two paths:       1. Visitor row exi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 641`** (1 nodes): `Attach a secondary anonymous_id to the canonical visitor. Many-to-one.     No ra`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 642`** (1 nodes): `Read-path service. Returns {events, cursor}.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 643`** (1 nodes): `Return {first_touch, last_touch} for a visitor. Used by Phase 48 funnels.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 644`** (1 nodes): `Resolve an anonymous visitor to an IAM user. Idempotent.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 645`** (1 nodes): `Add an alias row pointing alias_anonymous_id at visitor_id. Idempotent     via U`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 646`** (1 nodes): `Cardinality cap query — count distinct event_name in this workspace     for toda`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 647`** (1 nodes): `Sequential funnel: count distinct visitors who completed step N within     the t`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 648`** (1 nodes): `UTM dashboard aggregate. For each (utm_source, utm_campaign) seen in     evt_att`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 649`** (1 nodes): `Most-recent evt_attribution_touches row for this visitor.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 650`** (1 nodes): `Public-facing redemption attempt. Returns outcome + (if redeemed) reward shape.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 651`** (1 nodes): `Eligibility rule evaluator. Tiny JSONB AST interpreter — no DSL parsing, no stri`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 652`** (1 nodes): `Walk a dot path through nested dicts. Missing key returns _MISSING sentinel.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 653`** (1 nodes): `Evaluate `rule` against `context`. Empty / None rule = True (no constraint).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 654`** (1 nodes): `product_ops.referrals.attach — effect node, tx=own.  Called from the browser SDK`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 655`** (1 nodes): `Apply a flat dict of trait_code → value. Unknown codes are silently     dropped`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 656`** (1 nodes): `Caller submits a flat dict of trait_code → value. Server resolves     each trait`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 657`** (1 nodes): `Cache-able lookup: code → {id, value_type, label}. Stable across the run.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 658`** (1 nodes): `Unified client for the TennetCTL platform.      Modules (v0.2.1): auth, flags, i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 659`** (1 nodes): `Server-side Product Ops SDK namespace.  Mirrors the browser SDK's track/identify`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 660`** (1 nodes): `Server-side product analytics SDK.      Usage:       client = Tennetctl(...)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 661`** (1 nodes): `Emit a single custom event server-side.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 662`** (1 nodes): `Emit a pre-built batch (≤1000 events). Caller validates schema.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 663`** (1 nodes): `Resolve an anonymous visitor → IAM user. Idempotent.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 664`** (1 nodes): `Read path. Workspace-scoped.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 665`** (1 nodes): `Supported Versions Table`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 666`** (1 nodes): `Immutability — Return New Objects`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 667`** (1 nodes): `Pass conn not pool to services/repos`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 668`** (1 nodes): `frontend/src/types/api.ts single-file rule`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 669`** (1 nodes): `No any in TypeScript`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 670`** (1 nodes): `TypeScript API Calls Must Check ok`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 671`** (1 nodes): `Agents Routing Table`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 672`** (1 nodes): `Graphify Knowledge Graph Instructions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 673`** (1 nodes): `Future: Multi-touch attribution models`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 674`** (1 nodes): `Coverage Report Favicon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 675`** (1 nodes): `Coverage Report Sort Arrow Sprite`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
