...
# Rationale: single docker compose up with one Postgres instance for local dev

## Connections
- [[ADR-001 Postgres as the Primary and Only Required Database]] - `rationale_for` [EXTRACTED]
