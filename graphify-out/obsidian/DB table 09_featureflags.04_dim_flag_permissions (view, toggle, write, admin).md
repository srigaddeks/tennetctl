...
# DB table: 09_featureflags.04_dim_flag_permissions (view, toggle, write, admin)

## Connections
- [[featureflags.permissions repository — lnk_role_flag_permissions, v_role_flag_permissions]] - `references` [EXTRACTED]
