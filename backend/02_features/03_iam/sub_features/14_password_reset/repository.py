"""Repository for iam.password_reset."""

from __future__ import annotations

from typing import Any

_TABLE = '"03_iam"."27_fct_iam_password_reset_tokens"'
...
async def create_token(
    ...
    *,
    ...
    row = await conn.fetchrow(
        f"""
        INSERT INTO {_TABLE} (id, user_id, email, token_hash, ip_address, expires_at)
        VALUES ($1, $2, $3, $4, $5, $6)
        RETURNING *
        """,
        token_id, user_id, email, token_hash, ip_address, expires_at,
    )
    return dict(row)
